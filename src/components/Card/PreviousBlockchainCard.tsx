...
import { PreviousBlockchainData } from '@/assets/data/previousBlockchainData'
...
const PreviousBlockchainCard = () => {
  ...
  return (
    <>
      ...
      >
        {
          PreviousBlockchainData.map((item, key) => (
...
export default PreviousBlockchainCard