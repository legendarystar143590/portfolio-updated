...
const IntroService = () => {
  return (
    <div className="flex  bg-slate-700 dark:bg-slate-200 p-10 xl">
      <div className="flex flex-col w-full min-h-[85vh] xl:h-[80vh] items-center justify-center xl:flex-row gap-10 xl:gap-52">
        <div className="flex flex-col gap-10 w-full xl:w-2/5 text-center">
          <Typography size="h3">
